...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if($student_id == '' || $cse_101 == '' || $cse_102 == '' || $eee_163 == '' || $eee_164 == '' || $math_141 == '' || $chem_101 == '' || $hum_101 == '' || $hum_102 == '' || $ce_150 == '' || $gpa == '')
    {
      ...
      $query = "INSERT INTO level_one_term_one(student_id,cse_101,cse_102,eee_163,eee_164,math_141,chem_101,hum_101,hum_102,ce_150,gpa)VALUES('$student_id','$cse_101','$cse_102','$eee_163','$eee_164','$math_141','$chem_101','$hum_101','$hum_102','$ce_150','$gpa')";
