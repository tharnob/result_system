...
<?php
  ...
  $db = new Database();
  $query = "SELECT * FROM level_one_term_one";
 ...
 ?>
   <table class="tableOne" border="1">
     ...
     <tr>
       ...
       <td><a href="DatabaseResult11/update.php?id=<?php echo urlencode($row['id']); ?>">Edit</a></td>
   ...
   <a href="DatabaseResult11/create.php">Create</a>
