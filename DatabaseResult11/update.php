...
<head>
  ...
  <link rel="stylesheet" href="DatabaseResult11/index.css">
</head>
<body>
...
<?php
  ...
  $id = $_GET['id'];
  $db = new Database();
  $query = "SELECT * FROM level_one_term_one WHERE id=$id";
  ...
  if(isset($_POST['submit'])){
    ...
    if($student_id == '' || $cse_101 == '' || $cse_102 == '' || $eee_163 == '' || $eee_164 == '' || $math_141 == '' || $chem_101 == '' || $hum_101 == '' || $hum_102 == '' || $ce_150 == '' || $gpa == '')
    {
      ...
      $query = "UPDATE level_one_term_one SET student_id='$student_id',cse_101='$cse_101',cse_102='$cse_102',eee_163='$eee_163',eee_164='$eee_164',math_141='$math_141',chem_101='$chem_101',hum_101='$hum_101',hum_102='$hum_102',ce_150='$ce_150',gpa='$gpa' WHERE id='$id'";
  ...
  <?php
    ...
    if(isset($_POST['delete']))
    {
      ...
      $query = "DELETE FROM level_one_term_one WHERE id='$id'";
