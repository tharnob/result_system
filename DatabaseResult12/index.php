...
<?php
  ...
  $db = new Database2();
  $query = "SELECT * FROM level_one_term_two";
 ...
 ?>
   ...
   <table class="tableOne" border="1">
     ...
     <tr>
       ...
       <td><a href="DatabaseResult12/update.php?id=<?php echo urlencode($row['id']); ?>">Edit</a> </td>
   ...
   <a href="DatabaseResult12/create.php">Create</a>
