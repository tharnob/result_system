...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if($student_id == '' || $cse_201 == '' || $cse_202 == '' || $cse_203 == '' || $cse_204 == '' || $cse_205 == '' || $cse_206 == '' || $eee_269 == '' || $eee_270 == '' || $math_245 == '' || $gpa == '')
    {
      ...
      $query = "INSERT INTO level_two_term_two(student_id,cse_201,cse_202,cse_203,cse_204,cse_205,cse_206,eee_269,eee_270,math_245,gpa)VALUES('$student_id','$cse_201','$cse_202','$cse_203','$cse_204','$cse_205','$cse_206','$eee_269','$eee_270','$math_245','$gpa')";
