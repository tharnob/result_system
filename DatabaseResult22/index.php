...
<?php
  ...
  $db = new Database4();
  $query = "SELECT * FROM level_two_term_two";
 ...
 ?>
   ...
   <table class="tableOne" border="1">
     ...
     <tr>
       ...
       <td><a href="DatabaseResult22/update.php?id=<?php echo urlencode($row['id']); ?>">Edit</a> </td>
   ...
   <a href="DatabaseResult22/create.php">Create</a>
