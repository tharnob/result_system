...
<?php
  ...
  $id = $_GET['id'];
  $db = new Database5();
  $query = "SELECT * FROM level_three_term_one WHERE id=$id";
  ...
  if(isset($_POST['submit'])){
    ...
    if($student_id == '' || $phy_103 == '' || $cse_103 == '' || $cse_105 == '' || $cse_106 == '' || $eee_169 == '' || $eee_170 == '' || $math_143 == '' || $phy_104 == '' || $me_181 == '' || $me_181 == '')
    {
      ...
      $query = "UPDATE level_three_term_one SET student_id='$student_id',phy_103='$phy_103',cse_103='$cse_103',cse_105='$$cse_105',cse_106='$cse_106',eee_169='$eee_169',eee_170='$eee_170',math_143='$math_143',phy_104='$phy_104',me_181='$me_181',gpa='$gpa' WHERE id='$id'";
  ...
  <?php
    ...
    if(isset($_POST['delete']))
    {
      ...
      $query = "DELETE FROM level_three_term_one WHERE id='$id'";
