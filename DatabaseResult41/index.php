...
<?php
  ...
  $db = new Database7();
  $query = "SELECT * FROM level_four_term_one";
 ...
 ?>
   ...
   <table class="tableOne" border="1">
     ...
     <tr>
       ...
       <td><a href="DatabaseResult41/update.php?id=<?php echo urlencode($row['id']); ?>">Edit</a> </td>
   ...
   <a href="DatabaseResult41/create.php">Create</a>
