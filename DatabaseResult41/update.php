...
<?php
  ...
  $id = $_GET['id'];
  $db = new Database7();
  $query = "SELECT * FROM level_four_term_one WHERE id=$id";
  ...
  if(isset($_POST['submit'])){
    ...
    if($student_id == '' || $cse_201 == '' || $cse_202 == '' || $cse_203 == '' || $cse_204 == '' || $cse_205 == '' || $cse_206 == '' || $eee_269 == '' || $eee_270 == '' || $math_245 == '' || $gpa == '')
    {
      ...
      $query = "UPDATE level_four_term_one SET student_id='$student_id',cse_201='$cse_201',cse_202='$cse_202',cse_203='$cse_203',cse_204='$cse_204',cse_205='$cse_205',cse_206='$cse_206',eee_269='$eee_269',eee_270='$eee_270',math_245='$math_245',gpa='$gpa' WHERE id='$id'";
  ...
  <?php
    ...
    if(isset($_POST['delete']))
    {
      ...
      $query = "DELETE FROM level_four_term_one WHERE id='$id'";
