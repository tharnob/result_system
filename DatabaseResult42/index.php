...
<?php
  ...
  $db = new Database8();
  $query = "SELECT * FROM level_four_term_two";
 ...
 ?>
   ...
   <table class="tableOne" border="1">
     ...
     <tr>
       ...
       <td><a href="DatabaseResult42/update.php?id=<?php echo urlencode($row['id']); ?>">Edit</a> </td>
   ...
   <a href="DatabaseResult42/create.php">Create</a>
