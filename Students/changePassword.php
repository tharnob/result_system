<?php
  ...
  $problem = $student_fetch['password'];
  ...
  <div class="container ">
    ...
    <div class="border border-secondery rounded-sm p-5">
      ...
      <form action="" method = "POST">
        ...
        <button type="submit" class="btn btn-success" name = "passwordSubmit" value="submit">Submit</button>
        ...
        if(!empty($cp) && !empty($np) && !empty($cncp)) {
            ...
            if($np == $cncp){
              ...
              if($cp == $problem)
              {
                ...
                $insertion = "UPDATE student_signup SET password = '$np'  WHERE username = '$deafault' LIMIT 1";
              ...
              echo "
                ...
                <script>
                  alert ('Your Current Passwords did not match');
                  window.location.href='changePassword.php';
                </script>
