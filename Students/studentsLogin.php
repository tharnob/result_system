  ...
  <div class="container ">
    ...
    <div class="border border-secondery rounded-sm p-4">
      ...
      <form action="" method = "POST">
        ...
        <button type="submit" class="btn btn-primary" name="studentsLogin" value="Login">Login</button>
        <a href="../firstPage/firstPage.php" class="btn btn-primary" style="margin-left: 20px;">Go Home</a>
        <a href="studentSignup.php" class="btn btn-primary" style="margin-left: 20px;">Sign Up First</a>
      </form>
      ...
      <?php
...

        {
          ...
          $query = "select * from student_signup where username= '$user_name' AND password = '$pass' ";
          ...
          if(mysqli_num_rows($check) > 0)
          {
            ...
            $_SESSION['stdusername'] = $user_name;
