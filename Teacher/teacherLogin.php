  ...
  <div class="container ">
    ...
    <div class="border border-secondery rounded-sm p-4">
      ...
      <form action="" method = "POST">
        ...
        <button type="submit" class="btn btn-primary" name="teacherLogin" value="Login">Login</button>
        <a href="../firstPage/firstPage.php" class="btn btn-primary" style="margin-left: 20px;">Go Home</a>
        <a href="teacherSignup.php" class="btn btn-primary" style="margin-left: 20px;">Sign Up First</a>
      </form>
      ...
      <?php
...

        {
          ...
          $query = "select * from teacher_signup where username= '$user_name' AND password = '$pass' ";
