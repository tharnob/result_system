...
<body>
  ...
  <div class="jumbotron jumbotron-fluid bg-primary">
    <div class="container">
      <h1 class="text-center">Teacher Sign up Page</h1>
  ...
  <div class="container ">
    ...
    <div class="border border-secondery rounded-sm p-5">
      ...
      <form action="" method = "POST">
        ...
        <a href="teacherLogin.php" class="btn btn-primary" style="margin-left: 20px;">Login</a>
      </form>
      ...
      <?php
        ...
        if(!empty($name) && !empty($department) && !empty($phone) && !empty($email) && !empty($username)&& !empty($password) && !empty($confirm_password) && !empty($gender)) {
          ...
          if($password == $confirm_password)
          {
            ...
            if($query_check1 && $query_check2){
              ...
              if(mysqli_num_rows($query_check2) > 0)
              {
                ...
                // print_r($_POST);
                // exit();
               $insertion = "insert into teacher_signup(name,department,phone,email,username,password,gender) values ('$name','$department','$phone','$email','$username','$password','$gender')";
