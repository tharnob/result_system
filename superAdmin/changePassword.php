<?php
  ...
  $deafault = $_SESSION['superUsername'];

  $super_query = mysqli_query($con,"SELECT * FROM super_admin WHERE username = '$deafault'");

  $super_fetch = mysqli_fetch_assoc($super_query);

  $problem = $super_fetch['password'];
        ...
        if(!empty($cp) && !empty($np) && !empty($cncp)) {
            ...
            if($np == $cncp){
              ...
              if($cp == $problem)
              {
                ...
                $insertion = "UPDATE super_admin SET password = '$np'  WHERE username = '$deafault' LIMIT 1";
                ...
                if($run){
                  ...
                  echo "
                    ...
                    <script>
                      ...
                      window.location.href='superLogout.php';
                    </script>
