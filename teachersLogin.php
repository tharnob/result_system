  ...
  <div class="container ">
    ...
    <div class="border border-secondery rounded-sm p-4">
      ...
      <form action="" method = "POST">
        ...
        <button type="submit" class="btn btn-primary" name="teachersLogin" value="Login">Login</button>
      </form>
      ...
      <?php
...

        {
          ...
          $query = "select * from teachers_signup where user_name= '$user_name' AND password = '$pass' ";
          ...
          if(mysqli_num_rows($check) > 0)
          {
            echo "
              ...
              <script>
                ...
                window.location.href='teachersMain.php';
